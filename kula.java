...
class kula extends punktMaterialny {
    ...
    public void glownyMomentBezwladnosci(){
        glownyMomentBezwladnosci = 2*masa*odlegloscOdOsiX*odlegloscOdOsiY/5;
    }
    ...
    public kula(int masaTest, int promienTest){
        super(masaTest,0,0);
        promien = promienTest;
        glownyMomentBezwladnosci();
        wzglednyMomentBezwladnosci(odlegloscOdOsiX,odlegloscOdOsiY);
    ...
    public kula(int masaTest, int promienTest, int X, int Y){
        super(masaTest,3,4);
        promien = promienTest;
        odlegloscOdOsiX = X;
        odlegloscOdOsiY = Y;
